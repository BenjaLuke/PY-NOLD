...
class image:
    ...
    def __init__(self,languaje = 0):
        ...
        self.image_front = pygame.image.load("ART/scene_11_FRONT.png")
        self.image_back = pygame.image.load("ART/SCENE_11_BACK.png")
    ...
    def playing(self):
        ...
        while in_game:
            if self.turn == 1:
                self.calculate_paint_house(self.Barbara)
                self.paint_house(1)
                self.paint_between_walls()
                self.paint_house(2)
                self.Barbara.move()
    ...
    def ResetValues(self):
        ...
        all_windoor_atributes = ((1,1,(13,11),0,1,20,0,1,2,[1,2]),
                                 (1,1,(14,11),0,1,20,0,2,2,[1,2]),
                                 (1,1,(23,11),0,1,20,0,1,2,[1,3]),
                                 (1,1,(24,11),0,1,20,0,2,2,[1,3]),
                                 (2,1,(16,11),0,1,4,0,1,2,[1,2]),
                                 (2,1,(17,11),0,1,4,0,2,2,[1,2]),
                                 (2,1,(26,11),0,1,4,0,1,2,[1,3]),
                                 (2,1,(27,11),0,1,4,0,2,2,[1,3]),
                                                                  
                                 (2,1,(11,17),0,1,4,0,1,2,[1,2]),
                                 (2,1,(11,18),0,1,4,0,1,2,[1,2]),
                                 (2,1,(11,24),0,1,4,0,1,2,[1,6]),
                                 (2,1,(11,25),0,1,4,0,1,2,[1,6]),
                                 (1,1,(11,28),0,1,20,0,1,2,[1,6]),
                                 (1,1,(11,29),0,1,20,0,1,2,[1,6]),
                                 
                                 (2,1,(31,16),0,1,4,0,2,1,[11,3]),
                                 (2,1,(31,17),0,1,4,0,2,1,[11,3]),
                                 (1,1,(31,24),0,1,20,0,2,1,[11,7]),
                                 (1,1,(31,25),0,1,20,0,2,1,[11,7]),
                                 (2,1,(31,29),0,1,4,0,2,1,[11,7]),
                                 
                                 (2,1,(13,30),0,1,4,0,1,1,[10,6]),
                                 (2,1,(14,30),0,1,4,0,2,1,[10,6]),
                                 (1,1,(21,30),0,1,20,0,1,1,[10,7]),
                                 (1,1,(22,30),0,1,20,0,2,1,[10,7]),
                                 (2,1,(26,30),0,1,4,0,1,1,[10,7]),
                                 (2,1,(27,30),0,1,4,0,2,1,[10,7]),
                                 (2,1,(30,30),0,1,4,0,2,1,[10,7]),
                                 
                                 (2,1,(18,32),0,1,4,0,3,2,[10,9]),
                                 (2,1,(21,33),0,1,4,0,1,1,[11,9]),
                                 (1,1,(22,33),0,1,20,0,2,1,[11,9]),
                                 (1,1,(24,32),0,1,20,0,3,1,[11,9]),
                                 
                                 (1,1,(14,21),0,1,20,0,1,1,[4,6]),
                                 (1,1,(15,21),0,1,20,0,2,1,[4,6]),
                                 (1,1,(16,16),0,1,20,0,3,1,[4,2]),
                                 (1,1,(16,17),0,1,20,0,4,1,[4,2]),
                                 (1,1,(20,17),0,1,20,0,1,2,[4,5]),
                                 (1,1,(21,17),0,1,20,0,2,2,[4,5]),
                                 (1,1,(26,17),0,1,20,0,3,2,[4,3]),
                                 (1,1,(26,18),0,1,20,0,4,2,[4,3]),
                                 (1,1,(27,21),0,1,20,0,1,1,[4,7]),
                                 (1,1,(28,21),0,1,20,0,2,1,[4,7]),
                                 
                                 (1,1,(18,22),1,1,200,0,1,1,[8,6]),
                                 
                                 (2,1,(17,16),0,3,4,0,3,2,[13]),
                                 (2,1,(17,17),0,3,4,0,4,2,[13]),
                                 (2,1,(17,21),0,3,4,0,3,2,[13]),
                                 (2,1,(17,22),0,3,4,0,4,2,[13]),
                                 (2,1,(21,15),0,3,4,0,1,2,[13]),
                                 (2,1,(22,15),0,3,4,0,2,2,[13]),
                                 (2,1,(26,17),0,3,4,0,3,1,[13,11]),
                                 (2,1,(26,18),0,3,4,0,4,1,[13,11]),
                                 (2,1,(26,21),0,3,4,0,3,1,[13,11]),
                                 (2,1,(26,22),0,3,4,0,4,1,[13,11]),
                                 (2,1,(21,24),0,3,4,0,1,1,[13,11]),
                                 (2,1,(25,24),0,3,4,0,2,1,[13,11]))
        ...
        for i in range(len(all_windoor_atributes)):
            ...
            exec("self.windoor"+str(i)+".image ="+str(all_windoor_atributes[i][9]))
        ...
        self.Barbara.creation(1,"Barbara",1,[38,40],11,1)
    ...
    def calculate_paint_house(self,Character):
        ...
        # Si la escena es distinta a la anterior, se pone la transparencia a 255 y se guarda la imagen
        if Character.scene != self.scene:
            self.transparence_all_image = 255
            self.image = self.screen.copy()
            self.image_back = self.back.copy()
            self.image_front = self.front.copy()
        ...
        # Determinamos las x e y especiales si estamos en plantas distintas
        if scene == 12:
            x+=4
            y+=7
        if scene == 13:
        ...
        xr = ((self.width*(2033*self.zoom))/3440) + ((x-1)*((self.width*(48.70*self.zoom))/3440))-((y-1)*((self.width*(48.70*self.zoom))/3440))
        yr = y*((self.height*(24.35*self.zoom))/1440) + x*((self.height*(24.35*self.zoom))/1440) - ((self.height*(24.35*self.zoom))/1440)
        x = self.width/2 - xr
        y = self.height/2 - yr
        ...
        if level == 1:
            ...
            if self.transparence_all_image > 0:
                ...
                if self.first_inititation == True:
                    ...
                    self.image_back.set_alpha(self.transparence_all_image)      
                    self.image_front.set_alpha(self.transparence_all_image)
                            
                    # Ponemos la imagen en pantalla
                    self.screen.blit(self.image_back, (self.x_house,self.y_house))
                    self.screen.blit(self.image_front, (self.x_house,self.y_house))
